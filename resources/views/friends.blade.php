                ...
                @if(count($friend)>0)
                    <div u-grid class="uk-grid-collapse uk-flex-column uk-card uk-card-default uk-card-body uk-margin">
                        ...
                        <div class="uk-flex uk-flex-center uk-flex-middle">
                            <a class="mc-link-white" href="/account/{{$friend[0]->id}}">{{$friend[0]->first_name}}</a>
                        </div>
                    </div>
                @endif
                @endif
                    ...
                    <div u-grid class="uk-grid-collapse uk-flex-column uk-card uk-card-default uk-card-body uk-margin">
                        ...
                        <div class="uk-flex uk-flex-center uk-flex-middle">
                            <form action="{{ route('friend.confirm') }}" method="POST">
                                ...
                                <input type="submit" class="uk-button" value="Confirm friend"><br/>
                            </form>
                        </div>
                    </div>
                @endif
